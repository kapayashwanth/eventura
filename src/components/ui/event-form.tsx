...
import { Calendar, MapPin, Clock, X, Image, FileText, Tag, Users } from "lucide-react";
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            <label className="flex items-center gap-2 text-white/60 text-sm mb-2">
              <Image className="w-4 h-4" />Banner Image URL
            </label>
            <input
              type="url"
              value={bannerImage}
            ...
            {bannerImage && (
              <div className="mt-2 rounded-xl overflow-hidden border border-white/10">
                <img src={bannerImage} alt="Preview" className="w-full h-32 object-cover" onError={(e) => (e.currentTarget.style.display = 'none')} />
              </div>
            )}
          </div>
