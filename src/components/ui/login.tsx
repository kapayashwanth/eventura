    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#121212] relative overflow-hidden w-full">
          ...
          >
            ...
            <div className="w-full text-center mt-2">
              <span className="text-xs text-gray-400">
                ...
                <button type="button" onClick={onSwitchToSignup} className="underline text-white/80 hover:text-white">
                  Sign up, it&apos;s free!
                </button>
              </span>
            </div>
      ...
      >
        <p className="text-gray-400 text-sm mb-2">
          Join <span className="font-medium text-white">thousands</span> of users who are already using our platform.
        </p>
