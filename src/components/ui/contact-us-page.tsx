                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      <a href="mailto:support@myamrita.me" className="block text-white hover:text-indigo-400 transition-colors">
                        support@myamrita.me
                      </a>
                      <a href="mailto:careers@myamrita.me" className="block text-white hover:text-indigo-400 transition-colors">
                        careers@myamrita.me
                      </a>
                    </div>
                  </div>
